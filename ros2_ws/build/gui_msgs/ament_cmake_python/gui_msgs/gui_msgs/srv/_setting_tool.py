...
class Metaclass_SettingTool_Request(type):
    """Metaclass of message 'SettingTool_Request'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'gui_msgs.srv.SettingTool_Request')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__setting_tool__request
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__setting_tool__request
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__setting_tool__request
            cls._TYPE_SUPPORT = module.type_support_msg__srv__setting_tool__request
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__setting_tool__request
...
class SettingTool_Request(metaclass=Metaclass_SettingTool_Request):
    """Message class 'SettingTool_Request'."""
...
class Metaclass_SettingTool_Response(type):
    """Metaclass of message 'SettingTool_Response'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'gui_msgs.srv.SettingTool_Response')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__setting_tool__response
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__setting_tool__response
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__setting_tool__response
            cls._TYPE_SUPPORT = module.type_support_msg__srv__setting_tool__response
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__setting_tool__response
...
class SettingTool_Response(metaclass=Metaclass_SettingTool_Response):
    """Message class 'SettingTool_Response'."""
...
class Metaclass_SettingTool(type):
    """Metaclass of service 'SettingTool'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'gui_msgs.srv.SettingTool')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._TYPE_SUPPORT = module.type_support_srv__srv__setting_tool

            from gui_msgs.srv import _setting_tool
            if _setting_tool.Metaclass_SettingTool_Request._TYPE_SUPPORT is None:
                _setting_tool.Metaclass_SettingTool_Request.__import_type_support__()
            if _setting_tool.Metaclass_SettingTool_Response._TYPE_SUPPORT is None:
                _setting_tool.Metaclass_SettingTool_Response.__import_type_support__()


class SettingTool(metaclass=Metaclass_SettingTool):
    from gui_msgs.srv._setting_tool import SettingTool_Request as Request
    from gui_msgs.srv._setting_tool import SettingTool_Response as Response
