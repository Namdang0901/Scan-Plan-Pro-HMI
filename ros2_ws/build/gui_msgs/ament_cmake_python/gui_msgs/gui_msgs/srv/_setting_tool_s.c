...
bool gui_msgs__srv__setting_tool__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("gui_msgs.srv._setting_tool.SettingTool_Request", full_classname_dest, 46) == 0);
  }
  gui_msgs__srv__SettingTool_Request * ros_message = _ros_message;
  {  // req
...
{
  /* NOTE(esteve): Call constructor of SettingTool_Request */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("gui_msgs.srv._setting_tool");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SettingTool_Request");
...
ROSIDL_GENERATOR_C_EXPORT
bool gui_msgs__srv__setting_tool__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("gui_msgs.srv._setting_tool.SettingTool_Response", full_classname_dest, 47) == 0);
  }
  gui_msgs__srv__SettingTool_Response * ros_message = _ros_message;
  {  // tool_rpm
...
{
  /* NOTE(esteve): Call constructor of SettingTool_Response */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("gui_msgs.srv._setting_tool");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SettingTool_Response");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
