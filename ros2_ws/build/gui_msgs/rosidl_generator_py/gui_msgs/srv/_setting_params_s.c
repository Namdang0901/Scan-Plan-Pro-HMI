...
bool gui_msgs__srv__setting_params__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("gui_msgs.srv._setting_params.SettingParams_Request", full_classname_dest, 50) == 0);
  }
  gui_msgs__srv__SettingParams_Request * ros_message = _ros_message;
  {  // req
...
{
  /* NOTE(esteve): Call constructor of SettingParams_Request */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("gui_msgs.srv._setting_params");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SettingParams_Request");
...
ROSIDL_GENERATOR_C_EXPORT
bool gui_msgs__srv__setting_params__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("gui_msgs.srv._setting_params.SettingParams_Response", full_classname_dest, 51) == 0);
  }
  gui_msgs__srv__SettingParams_Response * ros_message = _ros_message;
  {  // linear
...
{
  /* NOTE(esteve): Call constructor of SettingParams_Response */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("gui_msgs.srv._setting_params");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SettingParams_Response");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
