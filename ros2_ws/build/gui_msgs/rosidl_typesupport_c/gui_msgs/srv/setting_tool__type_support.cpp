...
static const _SettingTool_Request_type_support_symbol_names_t _SettingTool_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, gui_msgs, srv, SettingTool_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, gui_msgs, srv, SettingTool_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, gui_msgs, srv, SettingTool_Request)() {
  return &::gui_msgs::srv::rosidl_typesupport_c::SettingTool_Request_message_type_support_handle;
}
...
static const _SettingTool_Response_type_support_symbol_names_t _SettingTool_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, gui_msgs, srv, SettingTool_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, gui_msgs, srv, SettingTool_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, gui_msgs, srv, SettingTool_Response)() {
  return &::gui_msgs::srv::rosidl_typesupport_c::SettingTool_Response_message_type_support_handle;
}
...
static const _SettingTool_type_support_symbol_names_t _SettingTool_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, gui_msgs, srv, SettingTool)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, gui_msgs, srv, SettingTool)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, gui_msgs, srv, SettingTool)() {
  return &::gui_msgs::srv::rosidl_typesupport_c::SettingTool_service_type_support_handle;
}
