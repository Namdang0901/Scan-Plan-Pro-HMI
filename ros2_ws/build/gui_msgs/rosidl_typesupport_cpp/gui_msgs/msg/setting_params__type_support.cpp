...
static const _SettingParams_type_support_symbol_names_t _SettingParams_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, gui_msgs, msg, SettingParams)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, gui_msgs, msg, SettingParams)),
  }
};
...
{
  return &::gui_msgs::msg::rosidl_typesupport_cpp::SettingParams_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, gui_msgs, msg, SettingParams)() {
  return get_message_type_support_handle<gui_msgs::msg::SettingParams>();
}
