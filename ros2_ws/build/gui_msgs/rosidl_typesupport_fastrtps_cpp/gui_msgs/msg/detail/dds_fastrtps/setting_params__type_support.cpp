...
#include "gui_msgs/msg/detail/setting_params__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const gui_msgs::msg::SettingParams & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  gui_msgs::msg::SettingParams & ros_message)
{
  // Member: linear
  cdr >> ros_message.linear;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_gui_msgs
max_serialized_size_SettingParams(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = gui_msgs::msg::SettingParams;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const gui_msgs::msg::SettingParams *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<gui_msgs::msg::SettingParams *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _SettingParams__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const gui_msgs::msg::SettingParams *>(
...
static size_t _SettingParams__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_SettingParams(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _SettingParams__callbacks = {
  "gui_msgs::msg",
  "SettingParams",
...
static rosidl_message_type_support_t _SettingParams__handle = {
...
{
  return &gui_msgs::msg::typesupport_fastrtps_cpp::_SettingParams__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, gui_msgs, msg, SettingParams)() {
  return &gui_msgs::msg::typesupport_fastrtps_cpp::_SettingParams__handle;
}
