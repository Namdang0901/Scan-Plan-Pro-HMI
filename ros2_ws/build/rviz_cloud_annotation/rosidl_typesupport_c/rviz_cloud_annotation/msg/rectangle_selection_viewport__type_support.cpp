...
static const _RectangleSelectionViewport_type_support_symbol_names_t _RectangleSelectionViewport_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rviz_cloud_annotation, msg, RectangleSelectionViewport)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rviz_cloud_annotation, msg, RectangleSelectionViewport)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, rviz_cloud_annotation, msg, RectangleSelectionViewport)() {
  return &::rviz_cloud_annotation::msg::rosidl_typesupport_c::RectangleSelectionViewport_message_type_support_handle;
}
