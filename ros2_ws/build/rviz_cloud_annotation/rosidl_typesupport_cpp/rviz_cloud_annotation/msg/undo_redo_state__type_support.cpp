...
static const _UndoRedoState_type_support_symbol_names_t _UndoRedoState_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rviz_cloud_annotation, msg, UndoRedoState)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rviz_cloud_annotation, msg, UndoRedoState)),
  }
};
...
{
  return &::rviz_cloud_annotation::msg::rosidl_typesupport_cpp::UndoRedoState_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, rviz_cloud_annotation, msg, UndoRedoState)() {
  return get_message_type_support_handle<rviz_cloud_annotation::msg::UndoRedoState>();
}
