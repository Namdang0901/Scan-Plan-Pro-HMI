...
#include <memory>
#include "../../../../src/rviz_embed_test/include/myviz/myviz.hpp"
...
QT_MOC_LITERAL(1, 6, 11), // "setCubeSize"
QT_MOC_LITERAL(2, 18, 0), // ""
QT_MOC_LITERAL(3, 19, 12) // "size_percent"

    },
    "MyViz\0setCubeSize\0\0size_percent"
};
...
void MyViz::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->setCubeSize((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    }
}
