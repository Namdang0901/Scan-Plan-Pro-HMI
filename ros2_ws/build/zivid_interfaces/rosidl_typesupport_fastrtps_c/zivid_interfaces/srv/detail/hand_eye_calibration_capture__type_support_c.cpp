  ...
  void * untyped_ros_message)
{
  ...
  _HandEyeCalibrationCapture_Request__ros_msg_type * ros_message = static_cast<_HandEyeCalibrationCapture_Request__ros_msg_type *>(untyped_ros_message);
  // Field name: robot_pose
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: detection_result_fiducial_markers
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, zivid_interfaces, msg, DetectionResultFiducialMarkers
      )()->data);
    if (!callbacks->cdr_serialize(
  ...
  void * untyped_ros_message)
{
  ...
  _HandEyeCalibrationCapture_Response__ros_msg_type * ros_message = static_cast<_HandEyeCalibrationCapture_Response__ros_msg_type *>(untyped_ros_message);
  // Field name: success
  {
    uint8_t tmp;
    cdr >> tmp;
