  ...
  void * untyped_ros_message)
{
  ...
  _InfieldCorrectionCompute_Request__ros_msg_type * ros_message = static_cast<_InfieldCorrectionCompute_Request__ros_msg_type *>(untyped_ros_message);
  // Field name: structure_needs_at_least_one_member
  {
    cdr >> ros_message->structure_needs_at_least_one_member;
  }
  ...
  void * untyped_ros_message)
{
  ...
  _InfieldCorrectionCompute_Response__ros_msg_type * ros_message = static_cast<_InfieldCorrectionCompute_Response__ros_msg_type *>(untyped_ros_message);
  // Field name: success
  {
    uint8_t tmp;
    cdr >> tmp;
