...
gui_msgs__msg__SettingParams__create()
{
  ...
  gui_msgs__msg__SettingParams * msg = (gui_msgs__msg__SettingParams *)allocator.allocate(sizeof(gui_msgs__msg__SettingParams), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(gui_msgs__msg__SettingParams));
  bool success = gui_msgs__msg__SettingParams__init(msg);
  if (!success) {
...
gui_msgs__msg__SettingParams__destroy(gui_msgs__msg__SettingParams * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    gui_msgs__msg__SettingParams__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
gui_msgs__msg__SettingParams__Sequence__init(gui_msgs__msg__SettingParams__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  gui_msgs__msg__SettingParams * data = NULL;

  if (size) {
    data = (gui_msgs__msg__SettingParams *)allocator.zero_allocate(size, sizeof(gui_msgs__msg__SettingParams), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = gui_msgs__msg__SettingParams__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        gui_msgs__msg__SettingParams__fini(&data[i - 1]);
      }
...
gui_msgs__msg__SettingParams__Sequence__fini(gui_msgs__msg__SettingParams__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      gui_msgs__msg__SettingParams__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  gui_msgs__msg__SettingParams__Sequence * array = (gui_msgs__msg__SettingParams__Sequence *)allocator.allocate(sizeof(gui_msgs__msg__SettingParams__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = gui_msgs__msg__SettingParams__Sequence__init(array, size);
  if (!success) {
...
gui_msgs__msg__SettingParams__Sequence__destroy(gui_msgs__msg__SettingParams__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    gui_msgs__msg__SettingParams__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
gui_msgs__msg__SettingParams__Sequence__are_equal(const gui_msgs__msg__SettingParams__Sequence * lhs, const gui_msgs__msg__SettingParams__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!gui_msgs__msg__SettingParams__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  gui_msgs__msg__SettingParams__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(gui_msgs__msg__SettingParams);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    gui_msgs__msg__SettingParams * data =
      (gui_msgs__msg__SettingParams *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!gui_msgs__msg__SettingParams__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          gui_msgs__msg__SettingParams__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!gui_msgs__msg__SettingParams__copy(
