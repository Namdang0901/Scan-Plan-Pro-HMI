...
double Form::radiansToDegrees(double radians) {
...
void Form::topic_callback(const sensor_msgs::msg::JointState::SharedPtr msg)
{
        ...
        ui->joint1_text->setText(QString::number(radiansToDegrees(msg->position[0]), 'f', 2));
        ui->joint2_text->setText(QString::number(radiansToDegrees(msg->position[1]), 'f', 2));
        ui->joint3_text->setText(QString::number(radiansToDegrees(msg->position[2]), 'f', 2));
        ui->joint4_text->setText(QString::number(radiansToDegrees(msg->position[3]), 'f', 2));
        ui->joint5_text->setText(QString::number(radiansToDegrees(msg->position[4]), 'f', 2));
        ui->joint6_text->setText(QString::number(radiansToDegrees(msg->position[5]), 'f', 2));
